  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="prose max-w-none">
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-3">1. Сбор и использование информации</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-3">2. Использование cookies</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-3">3. Ваши права</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold mt-6 mb-3">4. Контакты</h2>
        <p className="mb-4">
