...
const services = [
  {
    ...
    description:
      'Комплексная оценка системы обеспечения транспортной безопасности объекта на соответствие требованиям Федерального закона № 16-ФЗ.',
    icon: '🔍',
    features: [
      'Анализ уязвимостей',
  ...
  },
  {
    ...
    description:
      'Постоянное наблюдение за потенциальными угрозами и реагирование на инциденты',
    icon: '🛡️',
    features: [
      '24/7 мониторинг',
  ...
  },
  {
    ...
    description:
      'Повышение квалификации сотрудников в области транспортной безопасности',
    icon: '🎓',
    features: [
      'Программы обучения',
  ...
  },
  {
    ...
    title: 'Консультации',
    description:
      'Экспертные консультации по вопросам транспортной безопасности',
    icon: '💡',
    features: [
  ...
  },
  {
    ...
    description:
      'Помощь в получении аккредитации на деятельность в сфере транспортной безопасности',
    icon: '📋',
    features: [
  ...
  },
  {
    ...
    description:
      'Поставка и установка оборудования для обеспечения транспортной безопасности',
    icon: '⚙️',
    features: [
