      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto">
          {jobs.map((job, index) => (
            ...
            >
              <button
                className="w-full p-4 md:p-6 text-left bg-white hover:bg-gray-50 transition-colors flex justify-between items-start md:items-center"
              ...
              >
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap gap-2 mt-2">
                    <span className="px-2 py-1 bg-blue-100 text-blue-800 text-xs md:text-sm rounded-full max-w-full truncate md:whitespace-normal">
                      {job.department}
                    </span>
                ...
                <div className="text-gray-500 ml-2 flex-shrink-0">
                  {openJobId === job.id ? (
                    <svg
